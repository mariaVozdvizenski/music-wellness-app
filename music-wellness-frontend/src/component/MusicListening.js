...
function MusicListening() {
    ...
    useEffect(() => {
        if (songId) {
            SongService.getSong(songId).then(data => {
                ...
                setSongURLS(urls);
                setCurrentSong({ ...data });
                if (authenticationService.currentUserValue != null && data) {
                ...
                .then(() => {
                    MoodService.getMood(moodId).then(data => {
            ...
            SongService.getSongsByMood(moodId).then(data => {
                ...
                if (authenticationService.currentUserValue != null && data[0]) {
    ...
    return (<div className="music-listening">
        ...
        <Gif name={mood.moodName.toLowerCase()} source={getArtist()}></Gif>
        <MusicPlayer
